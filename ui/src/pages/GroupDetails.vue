  ...
  <q-page class="q-pa-md q-gutter-md">
    ...
    <div class="q-pb-md q-gutter-sm">
      <q-breadcrumbs>
        ...
        <q-breadcrumbs-el label="Group Details" />
      </q-breadcrumbs>
    </div>
    ...
    <div class="q-gutter-md">
      <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
        ...
        <q-input filled v-model="groupName" label="Group name" lazy-rules
          :rules="[val => val && val.length > 0 || 'Please enter group name']" />
...
const onSubmit = () => {
  ...
  axios({
    ...
    $q.notify("Error fetching group details");
    console.error(e);
  }).finally(() => {
    bar.value.stop();
  })
